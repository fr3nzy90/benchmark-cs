...
internal record EnormousModel
{
  ...
  public bool Propery19 { get; init; } = DataGenerator.RandomBool;

  public DateTime Propery19UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public int Propery20 { get; init; } = DataGenerator.RandomInt;

  public DateTime Propery20UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public string Propery21 { get; init; } = DataGenerator.RandomString;

  public DateTime Propery21UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public decimal Propery22 { get; init; } = DataGenerator.RandomDecimal;

  public DateTime Propery22UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public string Propery23 { get; init; } = DataGenerator.RandomString;

  public DateTime Propery23UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public IList<int> Propery24 { get; init; } = DataGenerator.RandomIntList(5);

  public DateTime Propery24UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public bool Propery25 { get; init; } = DataGenerator.RandomBool;

  public DateTime Propery25UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public int Propery26 { get; init; } = DataGenerator.RandomInt;

  public DateTime Propery26UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public string Propery27 { get; init; } = DataGenerator.RandomString;

  public DateTime Propery27UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public decimal Propery28 { get; init; } = DataGenerator.RandomDecimal;

  public DateTime Propery28UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public string Propery29 { get; init; } = DataGenerator.RandomString;

  public DateTime Propery29UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public IList<int> Propery30 { get; init; } = DataGenerator.RandomIntList(5);

  public DateTime Propery30UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public bool Propery31 { get; init; } = DataGenerator.RandomBool;

  public DateTime Propery31UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public int Propery32 { get; init; } = DataGenerator.RandomInt;

  public DateTime Propery32UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public string Propery33 { get; init; } = DataGenerator.RandomString;

  public DateTime Propery33UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public decimal Propery34 { get; init; } = DataGenerator.RandomDecimal;

  public DateTime Propery34UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public string Propery35 { get; init; } = DataGenerator.RandomString;

  public DateTime Propery35UpdatedOn { get; init; } = DataGenerator.RandomDateTime;

  public IList<int> Propery36 { get; init; } = DataGenerator.RandomIntList(5);

  public DateTime Propery36UpdatedOn { get; init; } = DataGenerator.RandomDateTime;
